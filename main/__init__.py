...
class Game(Const_Varaibles): 
    ...
    def main_loop(self):
        ...
        """
        #Images
        logo_vmk = images_saver().upload_image('images/click_logo.png', (100, 100))
        msu_logo = images_saver().upload_image('images/msu_logo.png', (100, 100))
        sad_logo = images_saver().upload_image('images/sadovnik.png', (100, 100))
        button_1 = images_saver().upload_image('images/button_1.png', (200, 50))
        butn_bckrnd = images_saver().upload_image('images/button_back_3.png', (250, 250))
        bckgrnd_im = images_saver().upload_image('images/Game_back.jpeg', (self.display_width, self.display_height))
